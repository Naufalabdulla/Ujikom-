                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('change/password/db') }}" class="md-float-material">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        <label for="basicInput" class="form-label">Enter Old Password</label>
                                        <input type="password" placeholder="Enter Old Password" class="form-control @error('current_password') is-invalid @enderror" 
                                        name="current_password" value="{{ old('current_password') }}" id="basicInput">
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        <label for="basicInput" class="form-label">Enter Current Password</label>
                                        <input type="password" placeholder="Enter Current Password" class="form-control @error('new_password') is-invalid @enderror" 
                                        name="new_password" id="basicInput">
                                    </div>
                                    @error('new_password')
                                        <span class="invalid-feedback" role="alert">
                                            {{ $message }}
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        <label for="basicInput" class="form-label">Choose Confirm Password</label>
                                        <input type="password" name="new_confirm_password" placeholder="Confirm Password" class="form-control" id="basicInput">
                                    </div>
                                </div>
                                <br>
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        <button type="submit" class="btn btn-primary btn-md shadow-lg">Change Password</button>
                                    </div>
                                </div>
                            </div>
                        </form>
