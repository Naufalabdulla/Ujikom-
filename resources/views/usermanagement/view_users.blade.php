    ...
    <div id="app">
        ...
        <nav class="main-sidebar ps-menu">
            ...
            <div class="sidebar-header">
                <img src="https://img.freepik.com/premium-vector/meta-metaverse-logo-isolated-white-new-facebook-logo_75010-313.jpg?w=2000" style="width: 100%; height: 100%;">
            ...
            <div class="sidebar-content">
                <ul>
                    ...
                    <li class="active">
                        ...
                        <ul class="sub-menu" style="max-height: 0px;">
                            <li class="active"><a href="{{ route('userManagement') }}" class="link">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <p class="form-text mb-2">For user to check they list</p>
                            </div>
