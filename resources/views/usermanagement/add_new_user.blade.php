...
<head>
    ...
    <title>Add New User &mdash; Page</title>
            ...
            <div class="col-xxl-4 col-xl-5 col-lg-6 col-md-7 col-sm-8">
                <div class="card shadow-lg">
                    <div class="card-body p-4">
                        <h1 class="fs-4 text-center fw-bold mb-4">Tambah User</h1>

                        <form method="POST" action="{{ route('user/add/save') }}" aria-label="abdul" data-id="abdul" class="needs-validation" novalidate=""
                            ...
                            <div class="mb-3">
                                <label class="mb-2 text-muted" for="email">Phone</label>
                                <div class="input-group input-group-join mb-3">
                                    ...
                                    <div class="invalid-feedback" role="alert">
                                        No.Telepon harus diisi terlebih dahulu
                                    </div>
                                </div>
                            </div>
