                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <form class="form form-horizontal" action="/pengelolaansp/store" method="POST">
                                    @csrf
                                    <div class="form-body">
                                        <div class="row">
                                                ...
                                                <div class="form-group has-icon-left">
                                                    <div class="position-relative">
                                                        <input type="text" class="form-control @error('nama') is-invalid @enderror"
                                                            placeholder="Nama Lengkap" id="first-name-icon" name="nama">
                                                ...
                                                <div class="form-group has-icon-left">
                                                    <div class="position-relative">
                                                        <input type="text" class="form-control @error('adabakhlak') is-invalid @enderror"
                                                            placeholder="Adab Akhlak" id="first-name-icon" name="adabakhlak">
                                                        <div class="form-control-icon">
