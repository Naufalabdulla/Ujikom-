                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <br>
                                <div class="col-md-12">
                                    <a href="/pengelolaansp/print">
                                        <button type="button" class="btn mb-2 btn-light icon-right">Print<i class="ti-printer"></i></button>
                                    </a> 
                                </div>
                                <br>
