                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Input SP</h4>
                        </div>
                        <div class="card-content">
                            <div class="card-body">
                                <form class="form form-horizontal" action="/pengelolaansp/{{ $pengelolaansp->id }}" method="POST">
                                    @method('put')
                                    @csrf
                                    <div class="form-body">
                                        <div class="row">
                                                ...
                                                <div class="form-group has-icon-left">
                                                    <div class="position-relative">
                                                        <input type="text" class="form-control @error('nama') is-invalid @enderror"
                                                            placeholder="Nama Lengkap" id="first-name-icon" name="nama" value="{{ $pengelolaansp->nama }}">
                                            ...
                                            <div class="col-md-4">
                                                <label>Adab Akhlak</label>
                                            </div>
                                            <div class="col-md-8">
                                                <div class="form-group has-icon-left">
                                                    <div class="position-relative">
                                                        <input type="text" class="form-control @error('adabakhlak') is-invalid @enderror"
                                                            placeholder="Adab Akhlak" id="first-name-icon" name="adabakhlak" value="{{ $pengelolaansp->adabakhlak }}">
                                                        <div class="form-control-icon">
                                            ...
                                            <div class="col-md-4">
                                                <label>Status Surat Peringatan</label>
                                            </div>
                                            <div class="col-md-8">
                                                <div class="position-relative">
                                                    <select class="form-select" name="statussp" aria-label="Default select example">
                                                        <option selected="">Status Surat Peringatan</option>
                                                        <option value="1" @if ($pengelolaansp->statussp == "1") selected @endif>1</option>
                                                        <option value="2" @if ($pengelolaansp->statussp == "2") selected @endif>2</option>
                                                        <option value="3" @if ($pengelolaansp->statussp == "3") selected @endif>3</option>
                                                    </select>
                                                </div>
                                            </div>
