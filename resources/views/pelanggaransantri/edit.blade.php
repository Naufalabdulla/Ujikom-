                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <form class="form form-horizontal" action="/pelanggaransantri/{{ $pelanggaransantri->id }}" method="POST">
                                    @method('put')
                                    @csrf
                                    <div class="form-body">
                                        <div class="row">
                                                ...
                                                <div class="form-group has-icon-left">
                                                    <div class="position-relative">
                                                        <input type="text" class="form-control @error('nama') is-invalid @enderror"
                                                            placeholder="Nama Lengkap" id="first-name-icon" name="nama" value="{{ $pelanggaransantri->nama }}">
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-group has-icon-left">
                                                    <div class="position-relative">
                                                        <input type="text" class="form-control @error('pelanggaran') is-invalid @enderror"
                                                            placeholder="Pelanggaran" id="first-name-icon" name="adabakhlak" value="{{ $pelanggaransantri->pelanggaran }}">
                                                        <div class="form-control-icon">
