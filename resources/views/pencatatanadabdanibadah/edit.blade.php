                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <form class="form form-horizontal" action="/pencatatanadabdanibadah/{{ $pencatatanadabdanibadah->id }}" method="POST">
                                    @method('put')
                                    @csrf
                                    <div class="form-body">
                                        <div class="row">
                                                ...
                                                <div class="form-group has-icon-left">
                                                    <div class="position-relative">
                                                        <input type="text" class="form-control @error('nama') is-invalid @enderror"
                                                            placeholder="Nama Santri" id="first-name-icon" name="nama" value="{{ $pencatatanadabdanibadah->nama }}">
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-group has-icon-left">
                                                    <div class="position-relative">
                                                        ...
                                                        id="first-name-icon" name="tanggalpencatatan" value="{{ $pencatatanadabdanibadah->tanggalpencatatan }}">
                                                        <div class="form-control-icon">
                                                ...
                                                <div class="form-group has-icon-left">
                                                    <div class="position-relative">
                                                        ...
                                                        id="first-name-icon" name="sholatlimawaktu">
                                                            <option value="{{ $pencatatanadabdanibadah->sholatlimawaktu }}">{{ $pencatatanadabdanibadah->sholatlimawaktu }}</option>
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-group has-icon-left">
                                                    <div class="position-relative">
                                                        <select class="form-select mb-3 @error('kualitas') is-invalid @enderror" aria-label="Default select example" 
                                                        id="first-name-icon" name="kualitas" value="{{ $pencatatanadabdanibadah->kualitas }}">
                                                            <option value="{{ $pencatatanadabdanibadah->kualitas }}">{{ $pencatatanadabdanibadah->kualitas }}</option>
                                                ...
                                                <div class="form-group has-icon-left">
                                                    <div class="position-relative">
                                                        <input type="text" class="form-control"
                                                            placeholder="Wajib diisi, - bila tidak ada catatan" id="first-name-icon" name="catatan" value="{{ $pencatatanadabdanibadah->catatan }}">
                                                        <div class="form-control-icon">
